        ...
        <div class="container">
            <div class="car-sale-widget">
                ...
                <div class="steps d-flex align-items-center">
                    <p class="mt-3">Hãy nhập thông tin về chiếc xe & thông tin cá nhân của bạn để chúng tôi hỗ trợ định
                        giá.</p>
                </div>
                <div class="car-price">
                    <div class="row">
                        ...
                        <div class="col-md-12 p-0">
                            <div class="form-inline">
                                ...
                                <div class="form-group col-4 position-relative">
                                    ...
                                    <i class="far fa-calendar-alt position-absolute" style="right: 30px"></i>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 p-0">
                        ...
                        <div class="col-md-12 p-0">
                            <div class="form-inline">
                                <div class="form-group col-12 d-flex justify-content-between align-items-center">
                                    <div class="btn" style="background-color:white;color:#a1a1a1; border: 1px solid #cacaca">
                                        <input type="file" placeholder="Upload your file ...">
                                    </div>
                                    <p style="font-size: 13px; color: #878787">* Chú ý: Giá trị thực tế của xe có thể sẽ có thay đổi một chút sau khi được kiểm định thực tế</p>
                                </div>
                            </div>
                            <div class="col-md-12 mt-4">
                                <h3>Thông tin của bạn</h3>
                                <p>Bạn hãy để lại thông tin để các chuyên gia của chúng tôi liên hệ và trợ giúp bạn định
                                    giá
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="element">
                            <p class="value"><i class="fas fa-coins mr-3"></i> Giá trị ước tính khoảng <span>450.000.000 - 500.000.000</span> VND
                            </p>
                            <p class="endo"><i class="fas fa-dollar-sign mr-2"></i> Ưu đãi đặc biệt, khi bán xe tại hệ thống
                                của
                            ...
                            <form action="" class="mt-5">
                                <div class="form-inline justify-content-between align-items-center">
                                    ...
                                    <a href="" class="tuvan" style="padding: 1rem 3.5rem">Tư vấn cho tôi ngay</a>
                                    <span class="change">Nếu bạn có nhu cầu đổi xe - <a href="">Bấm vào đây</a></span>
                                </div>
                            </form>
                        </div>
